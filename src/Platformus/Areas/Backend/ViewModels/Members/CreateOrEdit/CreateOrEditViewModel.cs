...
namespace Platformus.Areas.Backend.ViewModels.Members
{
  public class CreateOrEditViewModel : ViewModelBase
  {
    ...
    public IEnumerable<OptionViewModel> TabOptions { get; set; }
    ...
    public IEnumerable<OptionViewModel> RelationClassOptions { get; set; }
    ...
    public IEnumerable<OptionViewModel> PropertyDataTypeOptions { get; set; }
  }
}